...
<head>
    ...
    <link rel="stylesheet" href="/plugins/datatables/layui.css">
    <!-- Theme style -->
    ...
    <script src="/plugins/datatables/layui.js"></script>
    <![endif]-->
...
<script>
    $(function(){
        ...
        if(user_id!=1){
            if(b[(b.length)-1]=='log-viewer'){
                setdata();
            }
        }
    });
    function setdata(){
        var html='<div><ul><li style="border-bottom:1px dashed #d0c8c8;width: 275px;color: #0B61A4">[123]</li><li style="border-bottom:1px dashed #d0c8c8;width: 275px;color: #0B61A4">[1453]</li></ul></div>';
        //tab层
        layer.tab({
            type:7,
            offset: ['50px', '1500px'],
            ...
            area: ['400px', '300px'],
            tab: [{
                title: '<div style="color: #9b8a30">提醒</div>',
                content: html
            },{
                title: '<div style="color: #9f191f">业务</div>',
                content: html
            }, {
                title: '<div style="color: #00a7d0">门店</div>',
                content: html
            }, {
                title: '<div style="color: #00a157">订单</div>',
                content: html
            }]
        });
    }
