    ...
    <form class="" id='form' method="POST" action="{{url::route('pos.store.add')}}" >
        ...
        <div>
            ...
            <div class='fsb w100pc mg-t-15'  >
                ...
                <div class='mg-b-10' style='width:50%;'> <span class='red'>*</span> 商家编号  <input  style='width:60%;' type="text" disabled="disabled" placeholder='无需填写，系统自动生成编码' value="{{$store_code}}" name="store_code" /></div>
            </div>
