...
<div style="margin-top:30px;">
    ...
    <div class='flex jc-end' style='width:;'>
        <button class='bor-14 mg-l-10 w80px bor-n white bg-blue'><a href="{{$exporturl}}" class='white a_w'>导出</a></button>
    ...
    <table id="box" class="tableA w100pc mg-t-10" style="text-align: center;" border='1' rules='all' >
        ...
        <tr class='{{$prepayment->result_status!=0?"red":""}}'>
            ...
            <td>{{date('Y-m-d H:i:s',$prepayment->order_time)}}</td>
            <td>{{$prepayment->cpcc_time==0?"-": date('Y-m-d H:i:s',strtotime($prepayment->cpcc_time))}}</td>
